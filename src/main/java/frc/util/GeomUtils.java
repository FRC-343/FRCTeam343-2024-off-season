...
public class GeomUtils {
  ...
  /**
   * Converts a {@link Pose2d} to a {@link Transform2d} to be used in a kinematic chain
   *
  ...
  /**
   * Converts a {@link Transform2d} to a {@link Pose2d} to be used as a position or as the start of
   * a kinematic chain
   *
  ...
  /**
   * Assuming that the `PhotonTrackedTarget` provided is a Note, calculate the distance/rotation
   * from the Note and return that
   *
  ...
  public static Transform2d getTransformFromNote(PhotonTrackedTarget target) {
    ...
    Translation2d cameraToTarget =
        PhotonUtils.estimateCameraToTargetTranslation(
            distanceToTargetMeters, Rotation2d.fromDegrees(target.getYaw()));
