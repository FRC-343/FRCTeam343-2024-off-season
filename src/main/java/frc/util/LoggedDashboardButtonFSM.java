...
/**
 * Creates a logged Finite State Machine controlled by Command button inputs via SmartDashboard. All
 * inputs are logged to AdvantageKit, but controlled by SmartDashboard via their `putData(String
 * key, Command command)` method.
 */
